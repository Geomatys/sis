...
abstract class TemporalOperation<T> implements Serializable {
     ...
     */
    protected final boolean compare(final TimeMethods.Test test, final T self, final Instant other) {
        if (other != null) {
            ...
            if (p.isPresent()) {
                ...
                if (v == IndeterminateValue.NOW) {
                    ...
                    switch (test) {
                        case BEFORE:     if (v != IndeterminateValue.AFTER)  return false; else break;
                        case AFTER:      if (v != IndeterminateValue.BEFORE) return false; else break;
                        case NOT_BEFORE: if (v == IndeterminateValue.BEFORE) return false; else break;
                        case NOT_AFTER:  if (v == IndeterminateValue.AFTER)  return false; else break;
     ...
     * @throws DateTimeException if the two objects cannot be compared.
     */
    protected static boolean compare(final TimeMethods.Test test, final Instant self, final Instant other) {
        ...
        if (p1 != null || p2 != null) {
            final IndeterminateValue a1, a2;    // Values which would create ambiguities.
            switch (test) {
                case BEFORE: case NOT_AFTER:  a1 = IndeterminateValue.BEFORE; a2 = IndeterminateValue.AFTER;  break;
                case AFTER:  case NOT_BEFORE: a1 = IndeterminateValue.AFTER;  a2 = IndeterminateValue.BEFORE; break;
                case EQUAL:  return (p1 == p2) && (p1 == IndeterminateValue.NOW);
                default:     return false;
            }
        ...
        return TimeMethods.compareLenient(test, self.getPosition(), other.getPosition());
    }
     ...
     */
    private static boolean isAmbiguous(final IndeterminateValue p1, final IndeterminateValue required) {
    ...
    static final class Equals<T> extends TemporalOperation<T> {
        ...
        @Override public boolean evaluate(Period self, Period other) {
            return compare(TimeMethods.Test.EQUAL, self.getBeginning(), other.getBeginning()) &&
                   compare(TimeMethods.Test.EQUAL, self.getEnding(),    other.getEnding());
        }
    }
    ...
    static final class Before<T> extends TemporalOperation<T> {
        ...
        @Override public boolean evaluate(T self, Period other) {
            return compare(TimeMethods.Test.BEFORE, self, other.getBeginning());
        }
        ...
        /** Condition defined by ISO 19108:2006 (corrigendum) §5.2.3.5. */
        @Override public boolean evaluate(Period self, Period other) {
            return compare(TimeMethods.Test.BEFORE, self.getEnding(), other.getBeginning());
        }
    }
    ...
    static final class After<T> extends TemporalOperation<T> {
        ...
        /** Condition defined by ISO 19108:2006 (corrigendum) §5.2.3.5. */
        @Override public boolean evaluate(Period self, Period other) {
            return compare(TimeMethods.Test.AFTER, self.getBeginning(), other.getEnding());
        }
    }
    ...
    static final class Begins<T> extends TemporalOperation<T> {
        ...
        @Override public boolean evaluate(final Period self, final Period other) {
            return compare(TimeMethods.Test.EQUAL,  self.getBeginning(), other.getBeginning()) &&
                   compare(TimeMethods.Test.BEFORE, self.getEnding(),    other.getEnding());
        }
    }
    ...
    static final class Ends<T> extends TemporalOperation<T> {
        ...
        /** Condition defined by ISO 19108:2006 (corrigendum) §5.2.3.5. */
        @Override public boolean evaluate(final Period self, final Period other) {
            return compare(TimeMethods.Test.EQUAL, self.getEnding(),    other.getEnding()) &&
                   compare(TimeMethods.Test.AFTER, self.getBeginning(), other.getBeginning());
        }
    }
    ...
    static final class BegunBy<T> extends TemporalOperation<T> {
        ...
        @Override public boolean evaluate(final Period self, final Period other) {
            return compare(TimeMethods.Test.EQUAL, self.getBeginning(), other.getBeginning()) &&
                   compare(TimeMethods.Test.AFTER, self.getEnding(),    other.getEnding());
        }
    }
    ...
    static final class EndedBy<T> extends TemporalOperation<T> {
        ...
        @Override public boolean evaluate(final Period self, final Period other) {
            return compare(TimeMethods.Test.EQUAL,  self.getEnding(),    other.getEnding()) &&
                   compare(TimeMethods.Test.BEFORE, self.getBeginning(), other.getBeginning());
        }
    }
    ...
    static final class Meets<T> extends TemporalOperation<T> {
        ...
        /** Condition defined by ISO 19108:2006 (corrigendum) §5.2.3.5. */
        @Override public boolean evaluate(final Period self, final Period other) {
            return compare(TimeMethods.Test.EQUAL, self.getEnding(), other.getBeginning());
        }
    }
    ...
    static final class MetBy<T> extends TemporalOperation<T> {
        ...
        /** Condition defined by ISO 19108:2006 (corrigendum) §5.2.3.5. */
        @Override public boolean evaluate(final Period self, final Period other) {
            return compare(TimeMethods.Test.EQUAL, self.getBeginning(), other.getEnding());
        }
    }
    ...
    static final class During<T> extends TemporalOperation<T> {
        ...
        /** Condition defined by ISO 19108:2006 (corrigendum) §5.2.3.5. */
        @Override public boolean evaluate(final Period self, final Period other) {
            return compare(TimeMethods.Test.AFTER,  self.getBeginning(), other.getBeginning()) &&
                   compare(TimeMethods.Test.BEFORE, self.getEnding(),    other.getEnding());
        }
    }
    ...
    static final class Contains<T> extends TemporalOperation<T> {
        ...
        /** Condition defined by ISO 19108:2006 (corrigendum) §5.2.3.5. */
        @Override public boolean evaluate(final Period self, final Period other) {
            return compare(TimeMethods.Test.BEFORE, self.getBeginning(), other.getBeginning()) &&
                   compare(TimeMethods.Test.AFTER,  self.getEnding(),    other.getEnding());
        }
    }
    ...
    static final class Overlaps<T> extends TemporalOperation<T> {
        ...
        @Override public boolean evaluate(final Period self, final Period other) {
            ...
            return ((otherBegin = other.getBeginning()) != null) &&
                   ((selfBegin  = self.getBeginning())  != null) && compare(TimeMethods.Test.BEFORE, selfBegin, otherBegin) &&
                   ((selfEnd    = self.   getEnding())  != null) && compare(TimeMethods.Test.AFTER,  selfEnd,   otherBegin) &&
                   ((otherEnd   = other.  getEnding())  != null) && compare(TimeMethods.Test.BEFORE, selfEnd,   otherEnd);
        }
    }
    ...
    static final class OverlappedBy<T> extends TemporalOperation<T> {
        ...
        @Override public boolean evaluate(final Period self, final Period other) {
            ...
            return ((selfBegin  = self.getBeginning())  != null) &&
                   ((otherBegin = other.getBeginning()) != null) && compare(TimeMethods.Test.AFTER,  selfBegin,  otherBegin) &&
                   ((otherEnd   = other.  getEnding())  != null) && compare(TimeMethods.Test.BEFORE, selfBegin,  otherEnd)   &&
                   ((selfEnd    = self.   getEnding())  != null) && compare(TimeMethods.Test.AFTER,  selfEnd,    otherEnd);
        }
    }
    ...
    static final class AnyInteracts<T> extends TemporalOperation<T> {
        ...
        @Override public boolean evaluate(final Period self, final Period other) {
            ...
            return ((selfBegin  = self.getBeginning())  != null) &&
                   ...
                   ((otherBegin = other.getBeginning()) != null) && compare(TimeMethods.Test.AFTER, selfEnd, otherBegin);
        }
    }
}
