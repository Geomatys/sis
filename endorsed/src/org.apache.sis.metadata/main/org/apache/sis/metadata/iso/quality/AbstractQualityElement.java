 ...
 * See the {@link QualityElement} GeoAPI interface for more details.
 * The following property is mandatory in a well-formed metadata according ISO 19157:
 *
 * <div class="preformat">{@code QualityElement}
...
public class AbstractQualityElement extends ISOMetadata implements Element, QualityElement {
     ...
     */
    private static final long serialVersionUID = -4280300532997376740L;

    /**
     * Clause in the standalone quality report where this data quality element is described.
     *
     * @deprecated Replaced by {@link DefaultQualityEvaluationReportInformation#getQualityEvaluationReportDetails()}.
     *
     */
     ...
     */
    @SuppressWarnings("serial")
    private  Collection<EvaluationMethod> evaluationMethods;
     ...
     */
    @SuppressWarnings("serial")
    private Collection<QualityElement> derivedElements;

    /**
     * Constructs an initially empty element.
     */
    public AbstractQualityElement() {
    }
     ...
     */
    public AbstractQualityElement(final QualityResult result) {
        results = singleton(result, QualityResult.class);
    }
     ...
     *
     * @see #castOrCopy(QualityElement)
     */
    public AbstractQualityElement(final QualityElement object) {
        super(object);
        if (object != null) {
     ...
     *       {@code AbstractQualityElement}, then it is returned unchanged.</li>
     *   <li>Otherwise a new {@code AbstractQualityElement} instance is created using the
     *       {@linkplain #AbstractQualityElement(QualityElement) copy constructor} and returned.
     ...
     */
    public static AbstractQualityElement castOrCopy(final QualityElement object) {
        ...
        // class Usability is deprecated. The following instruction is kept only for retro-compatibility.
        ...
        if (object == null || object instanceof AbstractQualityElement) {
            return (AbstractQualityElement) object;
        }
        return new AbstractQualityElement(object);
    }
...
//    }
     ...
     */
    @Override
//    @XmlElement(name = "evaluationMethod")
    public Collection<EvaluationMethod> getEvaluationMethods() {
        return evaluationMethods = nonNullCollection(evaluationMethods, EvaluationMethod.class);
    }

    /**
     * Sets the evaluation information.
     *
     * @param  newValues  the new evaluation information.
     *
     * @since 1.3
     */
    public void setEvaluationMethods(final Collection<EvaluationMethod> newValues) {
        checkWritePermission(evaluationMethods);
        evaluationMethods = writeCollection(newValues, evaluationMethods, EvaluationMethod.class);
    }
...
//     *
//     * @deprecated Replaced by {@link #setEvaluationMethods}.
//     *
//     * @since 1.3
//     */
...
//    @XmlElement(name = "result", required = true)
     ...
     * @param  newValues  the new set of value.
     */
    public void setQualityResults(final Collection<? extends QualityResult> newValues) {
        results = writeCollection(newValues, results, QualityResult.class);
    }
