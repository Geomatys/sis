...
public enum DataType {
     ...
     */
    UNKNOWN(NumberType.VOID, Object.class, false, false, (byte) 0, null, null, true, true),
     ...
     */
    BYTE(NumberType.BYTE, Byte.class, true, false, (byte) 7, org.apache.sis.image.DataType.BYTE, "int8", true, true),
     ...
     */
    CHAR(NumberType.BYTE, Character.class, false, true, (byte) 2, null, null, false, true),   // NOT Numbers.CHARACTER

    /**
     * 16 bits signed integer (netCDF type 3) (zarr name "int16").
     */
    SHORT(NumberType.SHORT, Short.class, true, false, (byte) 8, org.apache.sis.image.DataType.SHORT, "int16", true, true),

    /**
     * 32 bits signed integer (netCDF type 4) (zarr name "int32").
     * This is also called "long", but that name is deprecated.
     */
    INT(NumberType.INTEGER, Integer.class, true, false, (byte) 9, org.apache.sis.image.DataType.INT, "int32", true, true),

    /**
     * 32 bits floating point number (netCDF type 5)
     * This is also called "real".
     */
    FLOAT(NumberType.FLOAT, Float.class, false, false, (byte) 5, org.apache.sis.image.DataType.FLOAT, "float32", true, true),

    /**
     * 64 bits floating point number (netCDF type 6)
     */
    DOUBLE(NumberType.DOUBLE, Double.class, false, false, (byte) 6, org.apache.sis.image.DataType.DOUBLE, "float64", true, true),

    /**
     * 8 bits unsigned integer (netCDF type 7) (zarr name "uint8").
     * Not available in netCDF classic format.
     */
    UBYTE(NumberType.BYTE, Short.class, true, true, (byte) 1, org.apache.sis.image.DataType.BYTE, "uint8", true, true),

    /**
     * 16 bits unsigned integer (netCDF type 8) (zarr name "uint16").
     * Not available in netCDF classic format.
     */
    USHORT(NumberType.SHORT, Integer.class, true, true, (byte) 3, org.apache.sis.image.DataType.USHORT, "uint16", true, true),

    /**
     * 32 bits unsigned integer (netCDF type 9) (zarr name "uint32").
     * Not available in netCDF classic format.
     */
    UINT(NumberType.INTEGER, Long.class, true, true, (byte) 4, org.apache.sis.image.DataType.UINT, "uint32", true, true),
     ...
     */
    BOOLEAN(NumberType.BOOLEAN, Boolean.class, false, false, (byte) 0, null, "bool", true, false),
