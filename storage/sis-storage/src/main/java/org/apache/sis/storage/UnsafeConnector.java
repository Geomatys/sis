 ...
 * {@code UnsafeConnector} wraps an input {@link Object}, which can be any of the following types:
 *
 * <ul>
 ...
 * Once a suitable {@code DataStore} has been found, the {@code UnsafeConnector} instance is typically
 ...
 * @module
 */
public class UnsafeConnector implements Serializable {
    /**
    ...
    /**
     * Handler to {@code UnsafeConnector.createFoo()} methods associated to given storage types.
    ...
    private interface Opener<T> {
         ...
         */
        T open(UnsafeConnector c) throws Exception;
    }
    ...
    static {
        add(String.class,           UnsafeConnector::createString);
        add(ByteBuffer.class,       UnsafeConnector::createByteBuffer);
        add(DataInput.class,        UnsafeConnector::createDataInput);
        add(ImageInputStream.class, UnsafeConnector::createImageInputStream);
        add(InputStream.class,      UnsafeConnector::createInputStream);
        add(Reader.class,           UnsafeConnector::createReader);
        add(Connection.class,       UnsafeConnector::createConnection);
     ...
     * </ul>
     *
     * An empty map means that this {@code UnsafeConnector} has been closed.
     *
     ...
     * {@link UnsafeConnector#closeAllExcept(Object)} method  (for example an {@link InputStreamReader} wrapping
     * an {@link InputStream}).
     *
     * Another purpose is to determine which views need to be synchronized if {@link UnsafeConnector#storage} is
    ...
    private static final class Coupled {
        /**
         * The {@link UnsafeConnector#storage} viewed as another kind of object.
         * Supported types are:
         *
         * <ul>
         *   <li>{@link ByteBuffer}:
        ...
        /**
         * Creates a wrapper for {@link UnsafeConnector#storage}. This constructor is used when we need to create
         ...
         * by this instance. This method is invoked before {@link UnsafeConnector#getStorageAs(Class)} returns a
         ...
         * this instance. This method is invoked before {@link UnsafeConnector#getStorageAs(Class)} returns a view,
         ...
         *
         * This method is for {@link UnsafeConnector#closeAllExcept(Object)} internal usage.
         *
        ...
        final boolean reset() throws IOException {
            ...
            if ((cascade & CLEAR_ON_RESET) != 0) {
                 ...
                 * (note: UnsafeConnector tries to instantiate ChannelDataInput in priority to all other types).
                 * If we don't find any, this is considered as a non-seekable channel (we do not assume that the
                 * channel original position was 0 when the user gave it to UnsafeConnector).
                 */
                String name = null;
                if (wrappedBy != null) {
         ...
         * This method is used for {@link UnsafeConnector#toString()} implementation only and may change
         * in any future version.
         *
         * @param appendTo  where to write name, value and children.
         * @param views     reference to the {@link UnsafeConnector#views} map. Will be read only.
         */
        @Debug
     ...
     */
    public UnsafeConnector(final Object storage) {
     ...
     * </ul>
     *
     * Multiple invocations of this method on the same {@code UnsafeConnector} instance will try
     ...
     * database connection returned by this method. In addition, those {@code probeContent(UnsafeConnector)}
     ...
     *               class or other type supported by {@code UnsafeConnector} subclasses.
     ...
     * @throws IllegalStateException if this {@code UnsafeConnector} has been {@linkplain #closeAllExcept closed}.
    ...
    public <T> T getStorageAs(final Class<T> type) throws IllegalArgumentException, DataStoreException {
        ...
        if (method == null) {
            ...
            try {
                ...
                Logging.recoverableException(StoreUtilities.LOGGER, UnsafeConnector.class, "getStorageAs", e);
                view = null;
            }
            addView(type, view);
            return view;
     ...
     * {@code UnsafeConnector} instance.</p>
     *
    ...
    /**
     * Closes all streams and connections created by this {@code UnsafeConnector} except the given view.
     ...
     *
     * <p>This {@code UnsafeConnector} instance shall not be used anymore after invocation of this method.</p>
     *
    ...
    public void closeAllExcept(final Object view) throws DataStoreException {
        if (views == null) {
            views = Collections.emptyMap();         // For blocking future usage of this UnsafeConnector instance.
    ...
    /**
     * Returns a string representation of this {@code UnsafeConnector} for debugging purpose.
     * This string representation is for debugging purpose only and may change in any future version.
     *
     * @return a string representation of this {@code UnsafeConnector} for debugging purpose.
     */
    @Override
    public String toString() {
