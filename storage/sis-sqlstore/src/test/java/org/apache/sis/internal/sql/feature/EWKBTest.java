...
public strictfp class EWKBTest extends TestCase {
    ...
    public void decodeHexadecimal(final String wkt, final String wkb) throws Exception {
        ...
        final EWKBReader<?> reader = new EWKBReader<>(GF, expectedCRS);
    ...
    public void testBinary() throws Exception {
        ...
        // Read the point.
        point.rewind();
        final GeometryWrapper<?> read = new EWKBReader<>(Geometries.implementation(GeometryLibrary.JTS), null).read(point);
