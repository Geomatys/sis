...
public final strictfp class DefaultAccuracyOfATimeMeasurementTest extends TestUsingFile {
    /**
     * An XML file containing quality information.
     */
    private static final String FILENAME = "AccuracyOfATimeMeasurement.xml";
    ...
    private void roundtrip(final String filename, final Version version) throws JAXBException {
        ...
        final InternationalString measureDescription = metadata.getMeasureDescription();
        /*
         * Programmatic verification of the text group.
         */
        assertEquals("Current description of the current measure", measureDescription.toString(Locale.ENGLISH));
        assertEquals("Description actuelle de la mesure actuelle", measureDescription.toString(Locale.FRENCH));
        /*
