...
public final strictfp class AbstractCompletenessTest extends TestUsingFile {
    /**
     * An XML file containing quality information.
     */
    private static final String FILENAME = "Completeness.xml";
    ...
    private void roundtrip(final String filename, final Version version) throws JAXBException {
        ...
        final DefaultDataQuality metadata2 = unmarshalFile(DefaultDataQuality.class, filename);
        /*
         * Programmatic verification of the text group.
         */
        getSingleton(metadata2.getReports());
        /*
