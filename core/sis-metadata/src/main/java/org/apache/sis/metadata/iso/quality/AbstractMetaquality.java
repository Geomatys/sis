 ...
 * @module
 */
@XmlType(name = "AbstractDQ_Metaquality_Type", propOrder = {
    " derivedElement"
})
...
public class AbstractMetaquality extends AbstractElement implements Metaquality {
    ...
    public AbstractMetaquality(final Metaquality object) {
        super(object);
        if (object != null) {
            derivedElement = (Collection<Element>) object.getDerivedElement();
        }
    }
    /**
     ...
     *       {@linkplain #AbstractMetaquality(Metaquality) copy constructor}
    ...
    /**
     * Sets the derived element.
     *
     * @param  newValues  the new derived element.
     */
    @Override
