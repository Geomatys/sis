 ...
 * {@code   └─reportReference……………} Reference to the procedure information, or {@code null} if none.
...
public class DefaultStandaloneQualityReportInformation extends ISOMetadata implements StandaloneQualityReportInformation {
     ...
     */
    private InternationalString Abstract;
     ...
     *
     * @return reference to the associated standalone quality report, or {@code null}.
     *
     * @see <a href="https://issues.apache.org/jira/browse/SIS-394">Issue SIS-394</a>
     */
    @Override
    @XmlElement(name = "reportReference")
    public Citation getReportReference() {
        return FilterByVersion.CURRENT_METADATA.accept() ? reportReference : null;
    }
    ...
    /**
     * Returns the abstract for the associated standalone quality report.
     *
     * @return abstract for the associated standalone quality report, or {@code null}.
     *
     * @see <a href="https://issues.apache.org/jira/browse/SIS-394">Issue SIS-394</a>
     */
    @Override
    ...
    public InternationalString getAbstract() {
        return FilterByVersion.CURRENT_METADATA.accept() ? Abstract : null;
    }
