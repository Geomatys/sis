 ...
 * {@code   ├─samplingScheme……………} Information of the type of sampling scheme and description of the sampling procedure.
 * {@code   ├─lotDescription……………} Information of how lots are defined.
 * {@code   ├─sampleRatio……………} Information on how many samples on average are extracted for inspection from each lot of population.</div>
 *
 * <p><b>Limitations:</b></p>
 * <ul>
...
public class DefaultSampleBasedInspection extends AbstractDataEvaluation implements SampleBasedInspection {
     ...
     */
    private InternationalString sampleRatio;
   ...
   /**
    ...
    public DefaultSampleBasedInspection(final SampleBasedInspection object) {
        ...
        if (object != null) {
            ...
            sampleRatio           = object.getSampleRatio();
        }
    }
     ...
     *       {@code DefaultSampleBasedDescription}, then it is returned unchanged.</li>
     *   <li>Otherwise a new {@code DefaultSampleBasedDescription} instance is created using the
     *       {@linkplain #DefaultSampleBasedDescription(SampleBasedDescription) copy constructor}
     ...
     *
     * @return the information of how lots are defined, or {@code null}.
     */
    @Override
     ...
     *
     * @return information on how many samples on average are extracted for inspection, or {@code null}.
     */
    @Override
    @XmlElement(name = "sampleRatio", required = true)
    public InternationalString getSampleRatio() {
        return sampleRatio;
    }
     ...
     * @param  newValue  the new information.
     */
    public void setSampleRatio(final InternationalString newValue) {
        checkWritePermission(sampleRatio);
        sampleRatio = newValue;
    }
}
