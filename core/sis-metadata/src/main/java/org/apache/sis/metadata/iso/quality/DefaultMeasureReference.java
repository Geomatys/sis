 ...
 *
 * <div class="preformat">{@code DQ_MeasureReference}
 * {@code   ├─measureIdentification……………} Information of the type of sampling scheme and description of the sampling procedure.
 * {@code   ├─nameOfMeasure……………} Information of how lots are defined.
 * {@code   ├─measureDescription……………} Information on how many samples on average are extracted for inspection from each lot of population.</div>
 *
 * <p><b>Limitations:</b></p>
 * <ul>
...
public class DefaultMeasureReference extends ISOMetadata implements MeasureReference {
    ...
    public DefaultMeasureReference(final MeasureReference object) {
        ...
        if (object != null) {
            ...
            namesOfMeasure           = (Collection<InternationalString>) object.getNamesOfMeasure();
    ...
    /**
     * Returns the identifier of the measure, value uniquely identifying the measure within a namespace.
     *
     * @return identifier of the measure, or {@code null}.
     *
    ...
    public Identifier getMeasureIdentification() {
        return FilterByVersion.CURRENT_METADATA.accept() ? measureIdentification : null;
    }

    /**
     * Sets the identifier of the measure, value uniquely identifying the measure within a namespace.
     *
    ...
    public  InternationalString getMeasureDescription() {
        return FilterByVersion.CURRENT_METADATA.accept() ? measureDescription : null;
    }
