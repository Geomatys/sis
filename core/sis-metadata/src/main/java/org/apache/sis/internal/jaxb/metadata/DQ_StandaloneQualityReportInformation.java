 ...
 * @module
 */
public final class DQ_StandaloneQualityReportInformation extends PropertyType<DQ_StandaloneQualityReportInformation, StandaloneQualityReportInformation> {
    /**
